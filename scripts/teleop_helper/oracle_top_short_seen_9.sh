#!/bin/bash
# Scripted check_point oracle for Top_Short_Seen_9 — collar-fold proxy.
...
OUTPUT_ROOT="Datasets/scripted_oracle/top_short_seen_9"
NUM_EPISODE="${NUM_EPISODE:-5}"
mkdir -p "$OUTPUT_ROOT"

echo "=========================================================================="
echo " ORACLE: Top_Short_Seen_9 — scripted bimanual fold (hem -> collar)"
echo "=========================================================================="
...
LEHOME_GLOBAL_KEYBOARD=1 ./third_party/IsaacLab/isaaclab.sh -p -m scripts.dataset_sim record \
    ...
    --enable_cameras \
    --device cpu \
    2>&1 | tee "/tmp/oracle_top_short_seen_9.log"
